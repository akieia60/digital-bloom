  ...
  return (
    <div className="min-h-screen bg-[var(--bg-page)]">
      ...
      <section className="relative pt-32 pb-16 px-6 text-center overflow-hidden">
        ...
        <Link
          to="/shop"
          className="relative inline-flex items-center text-[11px] uppercase tracking-[0.15em] text-[var(--text-secondary)] hover:text-[var(--accent-gold)] transition-colors mb-10 font-medium"
        >
        ...
        {/* Title */}
        <h1 className="relative text-4xl sm:text-5xl md:text-6xl font-display font-medium text-[var(--text-primary)] tracking-tight mb-5">
          {occasion.title}
        </h1>

        {/* Tagline */}
        <p className="relative text-lg sm:text-xl text-[var(--text-secondary)] font-light max-w-2xl mx-auto leading-relaxed">
          {occasion.tagline}
        </p>
