...
export default function CreditBalance() {
  ...
  const handleCheckBalance = async () => {
    ...
    if (!isValidCreditCodeFormat(code.toUpperCase())) {
      setError(t('balance_error_format'));
      return;
    }
    ...
    try {
      ...
      setError(err.message || t('balance_error_fetch'));
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="credits-page">
      <div className="landing-container">
        <div className="credits-hero">
          ...
          <p className="section-subtitle">{t('balance_subtitle')}</p>
        </div>

        {/* Balance Lookup Form */}
        <div className="balance-lookup">
          <div className="balance-form">
            <label className="customizer-label">{t('balance_code_label')}</label>
            <div className="balance-input-group">
              ...
              >
                {loading ? t('balance_checking') : t('balance_check_btn')}
              </button>
            </div>
