          ...
          <div className="glass border border-pure-gold/20 p-10 rounded-[2.5rem] flex flex-col bg-white/[0.02]">
            ...
            <div className="mt-8 pt-8 border-t border-white/5">
              ...
              <div className="flex justify-center flex-wrap gap-4 md:space-x-6">
                {/* TikTok */}
                <button className="text-white/40 hover:text-white transition-colors" title="Copy Link for TikTok" onClick={() => { navigator.clipboard.writeText('https://digitabloom.com'); alert('Link copied for TikTok!'); }}>
                ...
                {/* Instagram */}
                <button className="text-white/40 hover:text-[#E1306C] transition-colors" title="Copy Link for Instagram" onClick={() => { navigator.clipboard.writeText('https://digitabloom.com'); alert('Link copied for Instagram!'); }}>
                ...
                {/* X / Twitter */}
                <button className="text-white/40 hover:text-[#1DA1F2] transition-colors" title="Share to X" onClick={() => window.open('https://twitter.com/intent/tweet?text=I%20just%20customized%20a%20luxury%20digital%20bloom%20experience!', '_blank')}>
