    ...
    <div className="min-h-screen bg-[var(--surface-soft,#F7F7F7)] text-[var(--text-primary)]">
      ...
      <div className="max-w-3xl mx-auto px-5 sm:px-8 -mt-8 relative z-10 pb-24">
        ...
        <div className="bg-[var(--surface-white)] rounded-2xl p-7 sm:p-10 shadow-lg mb-8">
          ...
          >
            {t('product_customize_btn')}
          </button>

          {/* Feature labels — clearer and readable */}
          <div className="flex items-center justify-center gap-5 mt-6 flex-wrap">
            {[t('product_feature_digital'), t('product_feature_delivery'), t('product_feature_personalized')].map((label, i) => (
        ...
        {showSuccess && (
          <div className="bg-[var(--surface-white)] rounded-2xl p-7 shadow-lg mb-8 animate-fade-in border border-[var(--accent-gold-border)]">
            <div className="flex items-center gap-4 mb-5">
              ...
              <div>
                <p className="text-lg font-display font-semibold text-[#1D1D1F]">{t('product_added_title')}</p>
                <p className="text-sm text-[#6E6E73] mt-1">{t('product_added_desc')}</p>
              </div>
            </div>
        ...
        <div className="bg-[var(--surface-white)] rounded-2xl p-7 sm:p-10 shadow-lg mb-8">
          <h3 className="text-[11px] uppercase tracking-[0.15em] text-[var(--accent-gold)] font-bold mb-5">{t('product_details_heading')}</h3>
          {[
            { label: t('product_format_label'),   value: t('product_format_value') },
            { label: t('product_delivery_label'), value: t('product_delivery_value') },
            { label: t('product_access_label'),   value: t('product_access_value') },
          ].map((item, i) => (
