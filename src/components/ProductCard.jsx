  ...
  return (
    ...
    >
      <Link to={`/product/${product.id}`}>
        ...
        <div className="relative aspect-[3/4] overflow-hidden rounded-3xl bg-[var(--bg-surface)] border border-[var(--border-subtle)] transition-all duration-700 group-hover:shadow-xl group-hover:shadow-[var(--accent-gold-border)] group-hover:border-[var(--accent-gold-border-hover)]">
          ...
          {/* Price Badge */}
          <div className="absolute top-6 right-6 px-4 py-1.5 bg-black/70 backdrop-blur-sm rounded-full border border-[var(--border-default)]">
            <span className="text-xs font-semibold text-[var(--accent-gold)] tracking-wide">
        ...
        <div className="mt-5 px-1 text-center sm:text-left transition-all duration-500">
          <h3 className="text-base font-medium text-white group-hover:text-[var(--accent-gold)] transition-colors duration-300 tracking-tight">
            {product.name}
          </h3>
